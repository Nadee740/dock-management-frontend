...
export default function SideNavBar() {
  ...
  return (
   <>
<button data-drawer-target="sidebar-multi-level-sidebar" data-drawer-toggle="sidebar-multi-level-sidebar" aria-controls="sidebar-multi-level-sidebar" type="button" class="inline-flex items-start p-2 mt-2 ml-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
...
<aside id="sidebar-multi-level-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   ...
   <a href="https://flowbite.com/" class="flex items-center pl-2.5 mb-5">
      ...
      <ul class="space-y-2 font-medium">
         ...
         <FontAwesomeIcon icon={faTv} style={{color: "#b0b4ba",}} />
               <span class="ml-3">Dashboard</span>
            </Link>
         </li>
         <li>
            <Link to="/dock-booking"  class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
            <FontAwesomeIcon icon={faSquarePlus} style={{color: "#25b922",}} />
               <span class="ml-3">Dock Booking</span>
            </Link>
         </li>
         <li>
            <Link to="/real-time-status"  class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
            <FontAwesomeIcon icon={faClock} style={{color: "#24691b",}} />
               <span class="ml-3">REAL TIME STATUS</span>
            </Link>
         </li>
         <li>
         ...
         <li>
            <button type="button" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown2" data-collapse-toggle="dropdown2">
            <FontAwesomeIcon icon={faTruck} style={{color: "#34e2e5",}} />
                  <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item>List Vehicles</span>
                  <svg sidebar-toggle-item class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
            </button>
            <ul id="dropdown2" class="hidden py-2 space-y-2">
                  <li>
                     <Link to="/vehicle-update" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"> <FontAwesomeIcon icon={faPenToSquare} className="mr-2 text-indigo-500" />Update Vehicle Details</Link>
                  </li>
                  <li>
                     <Link to="/add-vehicle" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"><FontAwesomeIcon icon={faPlus} className="mr-2 text-green-500" /> Add Vehicle</Link>
                  </li>
            </ul>
         </li>
         <li>
            <button type="button" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown3" data-collapse-toggle="dropdown3">
            <FontAwesomeIcon icon={faUsers} style={{color: "#ec6d18",}} />
                  <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item>My Suppliers</span>
                  <svg sidebar-toggle-item class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
            </button>
            <ul id="dropdown3" class="hidden py-2 space-y-2">
                  <li>
                     <Link to=""  class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"> <FontAwesomeIcon icon={faUsers} style={{color: "#ec6d18",}} className="mr-2" />Supplier Group</Link>
                  </li>
            </ul>
         </li>
         <li>
         ...
         <li>
            ...
            <FontAwesomeIcon icon={faCheck} style={{color: "#72d123",}} />
               <span class="flex-1 ml-3 whitespace-nowrap">Approval Pending</span>

  ...
  return (
    <>
      ...
      <div className="flex  items-center pt-4 w-full sm:max-md:block">
        <input className="  w-2/6 ml-4 mr-6 h-10 ring-slate-200 ring-2 rounded-lg outline-none" placeholder="Search Supplier" onChange={(e) => { }} type="text"></input>
      ...
      <div className="flex items-center justify-between w-4/12 py-4 ml-3">

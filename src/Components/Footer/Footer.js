      ...
      <form action="">
        <div
          ...
          <div class="relative md:mb-6" data-te-input-wrapper-init>
            <input
              type="text"
              class="peer block min-h-[auto] w-full rounded border-0 bg-white px-3 py-[0.32rem] leading-[1.6] text-neutral-200 outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-full data-[te-input-state-active]:placeholder:opacity-full motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 [&:not([data-te-input-placeholder-active])]:placeholder:opacity-1000"
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-4">
      <div class="mb-6">
        ...
        <ul class="mb-0 list-none">
          ...
          <li>
            <a href="#!" class="text-white">Why Choose Us</a>
          </li>
          <li>
      ...
      <div class="mb-6">
        <h5 class="mb-2.5 font-bold uppercase">Product</h5>

        <ul class="mb-0 list-none">
          <li>
            <a href="#!" class="text-white">EZ Customer</a>
          </li>
          <li>
            <a href="#!" class="text-white">VEZ DMS</a>
          </li>
          <li>
            <a href="#!" class="text-white">Baggae operator<br></br> System</a>
          </li>
